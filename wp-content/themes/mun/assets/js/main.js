(function ($) {
    ...
    $( "#slider-range" ).slider({
        ...
        $( "#amount" ).val( "रू" + ui.values[ 0 ] + " - रू" + ui.values[ 1 ] );
       }
    });
    $( "#amount" ).val( "रू" + $( "#slider-range" ).slider( "values", 0 ) +
       " - रू" + $( "#slider-range" ).slider( "values", 1 ) );
