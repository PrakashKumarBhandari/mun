                ...
                <div class="container">
                    <div class="mun-navbar-inner">
                        ...
                        <div class="mid_brave align-center justify-content-center h-100">
                            <img class="black" src="<?php echo get_template_directory_uri();?>/assets/img/brave.svg" alt=""/>
                        </div>
                        <div class="mun-navbar-inner--right">
                            <div class="shop_head">
                                <div class="d-flex align-items-center justify-content-center h-100 logincart">
                                    <ul>
                                        <li>
                                        <?php
                                        $logged_in = false; 
                            ...
                            <div class="d-flex align-items-center justify-content-center h-100 mt-menu spbtn">
