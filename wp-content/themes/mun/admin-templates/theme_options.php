        ...
        <table>
            ...
            <tr valign="top">
                ...
                <th colspan='2'>
                    ...
                    <center> <u>Booking Message Body Setting</u></center> </th>
            </tr>
            <tr valign="top">
                <th scope="row"><?php _e(' Email Subject for Confirm Booking' ); ?></th>
                <td>
                <input id="theme_settings[confirm_booking]" type="text" size="36" name="theme_settings[confirm_booking]"
                        value="<?php esc_attr_e ($options['confirm_booking'] ); ?>" />                        
                   </td>
            </tr>
            <tr valign="top">
                <th scope="row"><?php _e(' Email Message for Confirm Booking' ); ?></th>
                <td><textarea id="theme_settings[confirm_booking_email]" name="theme_settings[confirm_booking_email]" rows="5"
                        cols="36"><?php esc_attr_e( $options['confirm_booking_email'] ); ?></textarea>
                     </td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php _e(' Email Subject for Reject Booking' ); ?></th>
                <td>
                <input id="theme_settings[reject_booking]" type="text" size="36" name="theme_settings[reject_booking]"
                        value="<?php esc_attr_e ($options['reject_booking'] ); ?>" />                        
                    
                    
            </td>
            </tr>
            <tr valign="top">
                <th scope="row"><?php _e(' Email Message of Rejected of Booking' ); ?></th>
                <td><textarea id="theme_settings[reject_booking_email]" name="theme_settings[reject_booking_email]" rows="5"
                        cols="36"><?php esc_attr_e( $options['reject_booking_email'] ); ?></textarea>
                     </td>
            </tr>
